...
if(strtolower($_SERVER['REQUEST_METHOD']) == "post"){
  ...
  ##---------------------------------------------------
	...
	(
      ...
      'password' => 'rgrr2g4c42@' # Senha do seu MailBox.
    );
...
<div class="container">
					...
					<div class="row">
                                    <div class="col-12 text-center">
                                      <h1 style="color: green;  font-size: 25px; padding-top: 63px;">Mensagem enviada com sucesso!</h1>
                                    </div>
